...
Effort: 43 mins
Purpose: Set, unset, check, and display flags (bits) inside of an unsigned array
of integers, consisting of 5 integers in the array, each sizeof(int)*8 bits long.
***********************************************************/
